class Screenpipe < Formula
  ...
  url "https://github.com/mediar-ai/screenpipe/releases/download/v0.0.4/screenpipe-0.0.4-aarch64-apple-darwin.tar.gz"
  version "0.0.4"

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/mediar-ai/screenpipe/releases/download/v#{version}/screenpipe-#{version}-aarch64-apple-darwin.tar.gz"
      sha256 "0b3e3a5878256dc9b8f3f8ff7760d35582633c852d8677116c8d294272e41df7" # arm64
    else
