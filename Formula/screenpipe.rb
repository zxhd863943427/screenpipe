class Screenpipe < Formula
  ...
  url "https://github.com/mediar-ai/screenpipe/releases/download/v0.0.1/screenpipe-0.0.1-aarch64-apple-darwin.tar.gz"
  version "0.0.1"

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/mediar-ai/screenpipe/releases/download/v#{version}/screenpipe-#{version}-aarch64-apple-darwin.tar.gz"
      sha256 "66451d0fdb8d0c7f1159a5674b66a1f2dcf84965acb978969bd1070d17d30237" # arm64
    else
