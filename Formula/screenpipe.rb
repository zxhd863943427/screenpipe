class Screenpipe < Formula
  ...
  url "https://github.com/mediar-ai/screenpipe/releases/download/v0.0.3/screenpipe-0.0.3-aarch64-apple-darwin.tar.gz"
  version "0.0.3"

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/mediar-ai/screenpipe/releases/download/v#{version}/screenpipe-#{version}-aarch64-apple-darwin.tar.gz"
      sha256 "efe9400f0453b5ac58bc1c00cac9a26378a6bd01ad88017f3b2133e79991ad7c" # arm64
    else
