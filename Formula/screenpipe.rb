class Screenpipe < Formula
  ...
  url "https://github.com/mediar-ai/screenpipe/releases/download/v0.0.2/screenpipe-0.0.2-aarch64-apple-darwin.tar.gz"
  version "0.0.2"

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/mediar-ai/screenpipe/releases/download/v#{version}/screenpipe-#{version}-aarch64-apple-darwin.tar.gz"
      sha256 "66effdb5300650472f0701de49dd0caea17626eb025233317e1f8a621bbb2b93" # arm64
    else
